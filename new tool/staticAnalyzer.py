        ...
        try:
            ...
            for line in smaliFile:
                try:
                        ...
                        if "Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;" in line and "invoke-virtual {" in line and "const-string" in prev_line1 and "const-string" in prev_line2:
                            log(logFile, file + ":" + str(i), line.split("\n")[0], 1)
                            if "String_Obfuscation_concat" in dangerousCalls:
                                continue
                            else:
                                dangerousCalls.append("String_Obfuscation_concat")
                        if "Ljava/lang/String;->append(Ljava/lang/String;)Ljava/lang/String;" in line and "invoke-virtual {" in line and "const-string" in prev_line1 and "const-string" in prev_line2:
                            log(logFile, file + ":" + str(i), line.split("\n")[0], 1)
                            if "String_Obfuscation_append" in dangerousCalls:
                                continue
                            else:
                                dangerousCalls.append("String_Obfuscation_append")
